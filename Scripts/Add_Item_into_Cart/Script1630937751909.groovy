...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_loginusername'), 'test')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/h2_Products'), 0)
